...
public class Pagamento {
    ...
    void deveLancarExcecaoParaPagamentoInvalido(double valor) {
        ...
        assertThrows(IllegalArgumentException.class, () -> digitalWallet.pay(valor), "O pagamento deve ter um valor válido.");
    }

    @Test
    void deveLancarSeNaoVerificadaOuBloqueada() {
        digitalWallet = new DigitalWallet("Arthur", 500);
        assertThrows(IllegalStateException.class, () -> digitalWallet.pay(1000));
    }
}
