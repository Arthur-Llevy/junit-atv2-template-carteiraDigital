...
class Deposito {
        ...
        void deveLancarExcecaoParaDepositoInvalido(double amount) {
            DigitalWallet digitalWallet = new DigitalWallet("Arthur", 0.0);
            assertThrows(IllegalArgumentException.class, () -> digitalWallet.deposit(amount), "Depósito com valor <= 0 deve lançar exceção");
        }
    }